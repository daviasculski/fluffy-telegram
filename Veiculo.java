public class Veiculo{
    private final double consumoPorLitro = 10; //estatico
    private Placa placa; // necessita da classe placa pra compilar
    ...
    public void setPais(String pais){
        placa.setPais(pais); //metodo set = void
                             //ou seja, nao retorna nada
                             //set altera, get consulta
    }
